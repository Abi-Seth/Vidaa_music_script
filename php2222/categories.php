...
<head>
    ...
    <meta name="description" content="VIDAA | Platfrom">
      ...
      <div id="wrapper">
         ...
         <ul class="sidebar navbar-nav toggled" style="transition:.2s ease;">
            ...
            <li class="nav-item dropdown active">
               <a class="nav-link dropdown-toggle" style="transition:.2s ease;" href="categories.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
