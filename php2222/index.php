...
<?php 
   include_once('./includes/data-fetch.php'); 
...
<html lang="en">
   ...
   <body id="page-top" class="sidebar-toggled">
         ...
         <ul class="navbar-nav ml-auto ml-md-0 abi-seth-right-navbar">
            ...
            <li class="nav-item dropdown no-arrow osahan-right-navbar-user">
               ...
               <?php
                  ...
                  {
                     echo '<img alt="Avatar" src="img/male_prof.jpg"></a>';
                  };
               ...
               <script>
                  ...
                  //open ajax object by ajax.open("method","url",async)
                  var method = "GET";
                  var url = "./includes/data-fetch.php";
                  ...
                  //receiving response from data-fetch.php
                  ajax.onreadystatechange = function()
                  {
                     if (this.readyState == 4 && this.status == 200)
                     {
                        ...
                        console.log(data);  // for debugging and testing

                        //html value for <span> name-user
                        var html = "";
                     ...
                     //     for(var a = 0; a < data.length; a++) 
                     //    {
                     //          var userName = data[2].uidUsers;
                     //    //       var userEmail = data[a].emailUsers;

                     //    //       //appending in html 
                     //          html += userName;
                     //    //          //html += "<td>" + userEmail + "</td>";
                     //     }
                     //      //replacing the span in html
                     //      document.getElementById("userNam").innerHTML += html;
                     //    }
                     }
                  } 
               </script>
      ...
      <div id="wrapper">
         ...
         <ul class="sidebar navbar-nav toggled" style="transition:.2s ease;">
            <li class="nav-item active">
               <a class="nav-link" href="index.php" style="transition:.2s ease;">
                        ...
                        <div class="main-title">
                           <div class="btn-group float-right right-action">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                 ...
                                 <a class="dropdown-item" href="#"><i class="fas fa-fw fa-signal"></i> &nbsp; Most Popular</a>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                          ...
                          <h6><i class="fas fa-fw fa-chart-line" style="color: #ff0000;"></i>
                           Trending</h6>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-signal" style="color: #ff0000;"></i> Top Videos</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-audio-description" style="color: #ff0000;"></i> Top audio albums</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-clock" style="color: #ff0000;"></i> Latest Videos</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Films & Animation</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Music</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Pets & Animals</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Sports</h6> 
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Travel & Events</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Gaming</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> Comedy</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> People & Blogs</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> News & Politics</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-sort-amount-down" style="color: #0099ffa9;"></i> How-To & Style</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6><i class="fas fa-fw fa-video" style="color: #ff0000;"></i> Others</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
               ...
               <div class="container">
                  <div class="row no-gutters">
                     <div class="col-lg-6 col-sm-6">
                        <p class="mt-1 mb-0">&copy; Copyright 2020 <strong class="text-dark">Vidaa</strong>. All Rights Reserved<br>
                           <small class="mt-0 mb-0">Made with <i class="fas fa-heart text-danger"></i> by <a
                                 class="text-primary" target="_blank" href="http://abi-seth.epizy.com/">Abi-Seth</a>
                           </small>
                        </p>
                     </div>
      ...
      <script>
      function userId() {
        // document.getElementById('userNam').innerHTML = 'AbiSeth';
      }
      userId(); 
      </script>
